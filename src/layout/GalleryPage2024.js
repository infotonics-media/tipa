...
const GalleryPage2024 = () => {
  ...
  useEffect(() => {
    axios
      .get(ENDPOINT + "gallery/gallery-2024")
      .then((res) => {
        setData({
          ...data,
    ...
    <>
      ...
      <div className="galleryPage">
        ...
        <div className="hero">
          ...
          {/* <div className="year italiana">2024</div> */}
          {/* <div
            onClick={() => {
        ...
        <div className="gallery-content">
          <div className="details">
            ...
            <div className="heading responsive-font-display">
              <Link to="/gallery2021">SEASON 1</Link>
              {'\u00A0'} {'\u00A0'} {'\u00A0'}
              <Link to="/gallery2022" >SEASON 2</Link>
              {'\u00A0'} {'\u00A0'}{'\u00A0'}
              <Link to="/gallery2024" style={{ textDecoration: "underline" }} >SEASON 3</Link>
              {'\u00A0'} {'\u00A0'}{'\u00A0'}
            </div>
...
export default GalleryPage2024;
